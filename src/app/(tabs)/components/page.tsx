...
export default function ComponentsPage() {
  ...
  return (
    <Box sx={{ p: { xs: 2, md: 4 }, maxWidth: 1200, mx: 'auto' }}>
      ...
      <Accordion expanded={expanded === 'tokens'} onChange={handleAccordionChange('tokens')}>
      ...
      {/* ── 2. Glossy Buttons ── */}
      <Accordion expanded={expanded === 'buttons'} onChange={handleAccordionChange('buttons')}>
        <AccordionSummary expandIcon={<ExpandMoreIcon />}>
          <Typography variant="h6" sx={{ fontWeight: 700 }}>
            Glossy Buttons
          </Typography>
      ...
      {/* ── 3. Text Fields ── */}
      <Accordion expanded={expanded === 'textfields'} onChange={handleAccordionChange('textfields')}>
        <AccordionSummary expandIcon={<ExpandMoreIcon />}>
          <Typography variant="h6" sx={{ fontWeight: 700 }}>
            Text Fields
          </Typography>
      ...
      {/* ── 4. Cards & Panels ── */}
      <Accordion expanded={expanded === 'cards'} onChange={handleAccordionChange('cards')}>
        <AccordionSummary expandIcon={<ExpandMoreIcon />}>
          <Typography variant="h6" sx={{ fontWeight: 700 }}>
            Cards & Panels
          </Typography>
      ...
      {/* ── 5. Alerts & Toasts ── */}
      <Accordion expanded={expanded === 'alerts'} onChange={handleAccordionChange('alerts')}>
        <AccordionSummary expandIcon={<ExpandMoreIcon />}>
          <Typography variant="h6" sx={{ fontWeight: 700 }}>
            Alerts & Toasts
          </Typography>
