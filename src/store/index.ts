...
function mergeConfig(persisted: unknown, current: ThemeStore): ThemeStore {
  ...
  return {
    ...
    config: {
      ...
      typography: {
        ...c.typography,
        ...(persistedConfig?.typography ?? {}),
        letterSpacingOverrides: { ...c.typography.letterSpacingOverrides, ...(persistedConfig?.typography?.letterSpacingOverrides ?? {}) },
        fontSizeOverrides: { ...(c.typography.fontSizeOverrides ?? {}), ...(persistedConfig?.typography?.fontSizeOverrides ?? {}) },
        lineHeightOverrides: { ...(c.typography.lineHeightOverrides ?? {}), ...(persistedConfig?.typography?.lineHeightOverrides ?? {}) },
